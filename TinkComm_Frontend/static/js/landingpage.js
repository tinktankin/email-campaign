document.querySelector('.login__link').onclick = function () {
    location.href = "login.html";
};

document.querySelector('.signup__link').onclick = function () {
    location.href = "signup.html";
};

document.querySelector('.signup__link__2').onclick = function () {
    location.href = "signup.html";
};

document.querySelector('.signup__link__3').onclick = function () {
    location.href = "signup.html";
};
...
//Note for the team - this is default js for this webpage template, mostly of no use to us, do not alter
//This was created to provide normalization rendering of html, css, js by the browsers created by nicholas
